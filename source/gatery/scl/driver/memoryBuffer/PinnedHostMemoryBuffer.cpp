...
void PinnedHostMemoryBuffer::unlock()
{
}

void PinnedHostMemoryBuffer::write(std::span<const std::byte> data)
{
...
void PinnedHostMemoryBuffer::read(std::span<std::byte> data) const
{
