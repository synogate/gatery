function (gtry_compileResourceFile)
	...
	add_custom_command(
		...
		COMMAND ${CMAKE_COMMAND} -D SOURCE_DIR=${CMAKE_CURRENT_SOURCE_DIR} -D OUTPUT=${GTRY_COMPILERESOURCEFILE_OUTPUT_PREFIX} -D FILES=${concatenated_files} -P ${CMAKE_CURRENT_SOURCE_DIR}/cmake/GtryFilesToResourceFile.cmake
		DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${GTRY_COMPILERESOURCEFILE_BINARY_FILES} ${CMAKE_CURRENT_SOURCE_DIR}/cmake/GtryFilesToResourceFile.cmake
		VERBATIM)
endfunction()